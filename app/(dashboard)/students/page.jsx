            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {isLoading ? (
                ...
                students.map((student) => (
                  <tr key={student.id} className="hover:bg-gray-100/30 transition-colors border-b border-gray-100">
                    ...
                    <td className="px-6 py-2 whitespace-nowrap text-right font-medium space-x-2">
                      ...
                      <button onClick={() => setDeleteConfirm(student.id)} className="text-gray-400 hover:text-red-600 transition-colors bg-gray-50 hover:bg-red-50 p-2 rounded-lg inline-flex" title="Delete Student">
                        <Trash2 size={18} />
                      </button>
                    </td>
                  </tr>
